{config_load file=$settings.language_file section="general"}{config_load file=$settings.language_file section="avatar"}<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Strict//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-strict.dtd">
...
{else}
<p class="delete"><a href="index.php?mode=avatar&amp;delete=true"><img src="templates/{$settings.template}/images/delete.png" alt="" width="16" height="16" /><span>{#delete_avatar#}</span></a></p>
{/if}
{elseif $upload}
