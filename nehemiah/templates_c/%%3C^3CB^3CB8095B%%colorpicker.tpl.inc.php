<?php /* Smarty version 2.6.22, created on 2009-03-03 00:24:22
         compiled from default/subtemplates/colorpicker.tpl.inc */ ?>
<div id="colorpicker">
<?php echo '
...
for(var i = 0; i < colors.length; ++i)
 {
  document.write(\'<td style="background:\'+colors[i]+\';"><a href="#" onclick="bbcode(\\\'text\\\',\\\'color\\\',\\\'\'+colors[i]+\'\\\'); hide_element(\\\'colorpicker\\\'); return false"><img src="templates/'; ?>
<?php echo $this->_tpl_vars['settings']['template']; ?>
<?php echo '/images/plain.png" alt="\'+colors[i]+\'" title="" width="15" height="15" /></a></td>\');
