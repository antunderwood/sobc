...
<img src="<?= $html_root?>/images/old_plan.gif">
<p>
...
<ul>
	<li>A worship area for 150 people, expandable to over 180 by moving a flexible partition.</li>
	...
	<img src="<?= $html_root?>/images/new_plan.gif">
...
<br><img src="<?= $html_root?>/images/new_building_small.jpg"><br>
...
<p>
In July 2000, members voted to open a building fund for the extension. We have been giving to that fund from within the congregation over the past 6 years. We are grateful to Oxhey Village chapel, the people of Bushey Baptist and other friends of the church for their help and encouragement.

In 2004 the architect was chosen and outline plans were drawn up. In 2005 the plans were refined and submitted for planning permission, which was received in December. No neighbours objected and those that did express an opinion were very favourable and encouraging.

A quantity surveyor estimates the cost of the building to be &#163;440,000. 
The building fund stood at approximately &#163;198,500 (January 2007). 
Approximately half of this has come in the last 2 years.
For the current figure <a href="<?= $html_root?>/index.mhtml#building_news">Latest Building news</a>.

We have made some minor refinements to the plans and are looking at which areas of the project we may be able to do ourselves. 

The requirement for the building is urgent and the rate at which funds are growing is increasing. We are looking to build in 2008, starting in the early part of the year.
