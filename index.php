...
<table width="100%" cellspacing="0" cellpadding="0" border="0">
    <tbody>
        <tr>
			...
			new Tip('new_building', "We are building the outer shell with the money we have and looking to continue with the inside as money becomes available. We have been talking about 'stepping out of the boat' for years. This is it. The rain and mud of January made the idea of the boat and water all very literal!<div style=\"text-align:center\"><h2>South Oxhey Baptist Church</h2>Building to serve the peopleof South Oxhey<br>New worship area<br>Activity rooms for all ages<br>Open house with catering facilities<h2>… aiming to be a welcoming community of people with Jesus Christ at the centre</h2></div>For a slideshow of the current building work in progress please <a href='javascript:;' onclick=\"$('new_building').prototip.hide();Lightview.show('slideshow');\">click here</a>", { 
