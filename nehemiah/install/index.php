...
switch($action)
 {
  case 'install':
   ...
   ?><form action="index.php" method="post">
       ...
       <td class="admintab-r"><input type="text" name="forum_name" value="<?php if (isset($_POST['forum_name'])) echo stripslashes($_POST['forum_name']); else echo $default_settings['forum_name']; ?>" size="40" /></td>
       </tr>
       <tr>
