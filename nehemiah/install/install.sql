...
CREATE TABLE mlf2_userdata (user_id int(11) NOT NULL auto_increment, user_type tinyint(4) NOT NULL default '0', user_name varchar(255) NOT NULL default '', user_real_name varchar(255) NOT NULL default '', gender tinyint(4) NOT NULL default '0', birthday date NOT NULL default '0000-00-00', user_pw varchar(255) NOT NULL default '', user_email varchar(255) NOT NULL default '', email_contact tinyint(4) default '0', user_hp varchar(255) NOT NULL default '', user_location varchar(255) NOT NULL default '', signature varchar(255) NOT NULL default '', profile text NOT NULL, logins int(11) NOT NULL default '0', last_login timestamp NOT NULL default CURRENT_TIMESTAMP, last_logout timestamp NOT NULL default '0000-00-00 00:00:00', user_ip varchar(255) NOT NULL default '', registered timestamp NOT NULL default '0000-00-00 00:00:00', thread_order tinyint(4) NOT NULL default '0', user_view tinyint(4) NOT NULL default '0', sidebar tinyint(4) NOT NULL default '1', fold_threads tinyint(4) NOT NULL default '0', thread_display tinyint(4) NOT NULL default '0', new_posting_notification tinyint(4) default '0',new_user_notification tinyint(4) default '0',time_difference smallint(4) default '0', user_lock tinyint(4) default '0', auto_login_code varchar(255) NOT NULL default '', pwf_code varchar(255) NOT NULL, activate_code varchar(255) NOT NULL default '', PRIMARY KEY (user_id)) CHARSET=utf8 COLLATE=utf8_general_ci;
...
CREATE TABLE mlf2_entries_cache (cache_id int(11) NOT NULL, cache_text text NOT NULL, PRIMARY KEY (cache_id)) CHARSET=utf8 COLLATE=utf8_general_ci;
...
INSERT INTO mlf2_settings VALUES ('template', 'default');
...
INSERT INTO mlf2_settings VALUES ('max_thread_indent_mix_topic', '500');
...
INSERT INTO mlf2_settings VALUES ('bbcode_code', '1');
...
INSERT INTO mlf2_settings VALUES ('name_word_maxlength', '25');
INSERT INTO mlf2_settings VALUES ('email_maxlength', '50');
INSERT INTO mlf2_settings VALUES ('hp_maxlength', '70');
INSERT INTO mlf2_settings VALUES ('location_maxlength', '40');
INSERT INTO mlf2_settings VALUES ('location_word_maxlength', '25');
INSERT INTO mlf2_settings VALUES ('subject_maxlength', '60');
INSERT INTO mlf2_settings VALUES ('subject_word_maxlength', '25');
...
INSERT INTO mlf2_settings VALUES ('very_deep_reply', '20');
...
INSERT INTO mlf2_settings VALUES ('version', '2.0.2');
...
INSERT INTO mlf2_userdata VALUES (1, 2, 'admin', '', 0, '0000-00-00', 'c3ccb88dc0a985b9b5da20bb9333854194dfbc7767d91c6936', 'admin@domain.tld', 1, '', '', '', '', 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00', '', NOW(), 0, 0, 1, 0, 0, 0, 0, 0, 0, '', '', '');
