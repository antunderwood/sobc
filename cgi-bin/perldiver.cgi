...
my $ver  = sprintf "%d.%02d", '$Revision: 2.031 $ ' =~ /(\d+)\.(\d+)/;
...
Copyright 1997-2003, Creative Fundamentals, Inc.
(I<L<http://creativefundamentals.com>>) dba ScriptSolutions
